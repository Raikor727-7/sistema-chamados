    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('citizen', 'Cidadão'), ('analyst', 'Analista'), ('manager', 'Gestor'), ('admin', 'Administrador')], default='citizen', max_length=20, verbose_name='Tipo de usuário')),
